...
地理编码接口会把**全国所有同名的地方**都返回回来。搜「上海」给 7 条：除了上海市（2487 万人）之外，另外
6 条是云南、浙江、四川的同名村子 —— 界面上显示成「上海 · 云南 · 中国」「上海 · 四川 · 中国」，名字一样，
看不出区别，等于让人瞎猜。

所以这里拿**人口**当分辨器：

- 按人口从大到小排，最可能是你要的那个排在最上面；
- **只要有一条有人口，就把没人口的全丢掉**（这种地方基本都是村子）；
- 一条有人口的都没有，就原样列出 —— 没得筛的时候，删成空的比列得多更糟；
- 候选的副标题里写出来人口，「上海 · 中国 · 2487 万人」一眼就知道是不是自己要的那个。

代价：个别人要找的若是那个同名村子，它就搜不到了（可以改搜附近的城镇）。这里的取舍是：一排分不清的
候选不是「更多选择」，只是把选择的工作推给了用户。
